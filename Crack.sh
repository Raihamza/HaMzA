...
echo $i" |"$pu" Contack WhatsApp :"$ku" 03496059844"$i" |"
echo $i" |"$pu" Contack Gmail :"$ku" ameerhamzagodgor4@gmail.com"$i" |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"──────────────────────────────── ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" 03496059844"
echo $ku"Facebook :"$i" Hamza Hacker"
sleep 2
